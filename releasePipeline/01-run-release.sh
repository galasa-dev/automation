...
bold "3. Deploy to Maven Central (scripts 30-32)"
bold "4. Deploy Docker images (script 34)"
bold "5. Tag repositories (script 41)"
bold "6. Upload releases (docs 42-43)"
bold "7. Update installers (doc 44)"
bold "8. Bump version (doc 95)"
bold "9. Clean up (script 03, 92)"
